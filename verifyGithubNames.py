#!/usr/bin/env python3
#
#cool little script I found to check available names on github 
# Usage:
...
#   
#   EDIT ( Ryan McVicker ) 
#   can also use some command line basics for filtering in conjunction with a word list 
#
#   Usage : 
#       cat words_alpha.txt | grep -E '\br' | verifyName 
#       
...
#rewrite as flask rest api 

import sys
import argparse 
from flask import Flask 
from flask_restul import Api , Resoure , reqparse
